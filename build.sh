...
# Added blackPanther OS support to build script
if [ -e /usr/bin/installing ] ; then
   echo ""
   echo "Check/Install: git cmake binutils fuse glibc-devel glib2-devel libfuse-devel gcc zlib-devel libpng12_0"
   sleep 2
   installing --auto git cmake binutils fuse glibc-devel glib2-devel libfuse-devel gcc zlib-devel libpng12_0
else
